                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-bayar" method="POST">
                                    ...
                                    <input type="hidden" name="id_kasir" value="<?= @$_SESSION['id_user'] ?>">
    ...
    <!-- Vendors JS -->
     <script>
        document.getElementById('form-bayar').addEventListener('submit', function(e) {
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
                    // Jika pembayaran berhasil, lakukan sesuatu
                    alert('Pembayaran berhasil!');
                    // Kamu bisa memperbarui status UI atau melakukan redirect
                    location.reload();  // Ini akan me-refresh halaman untuk melihat perubahan
                } else {
